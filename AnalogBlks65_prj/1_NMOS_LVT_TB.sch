...
<Properties>
  ...
  <Grid=10,10,1>
  <DataSet=1_NMOS_LVT_TB.dat>
  <DataDisplay=1_NMOS_LVT_TB.dpl>
  <OpenDisplay=0>
  <Script=1_NMOS_LVT_TB.m>
  <RunScript=0>
  <showFrame=0>
  <FrameText0=Title>
  <FrameText1=Drawn By:>
...
<Components>
  ...
  <SpicePar SpicePar1 1 770 140 -26 17 0 0 "vgs=420m" 1 "vds=420m" 1 "vsb=0" 1>
  <NMOS_SPICE M1 1 290 440 -26 34 0 0 "n_12_lllvt W=2.5u L=130n SA=160n SB=160n SD=0 AD=400f AS=400f PD=5.32u PS=5.32u SCA=10.0629 SCB=6.61293m SCC=1.11565m" 0 "" 0 "" 0 "" 0 "" 0>
