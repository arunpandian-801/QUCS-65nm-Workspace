...
<Properties>
  <View=-71,-193,1343,607,0.853567,0,1>
  <Grid=10,10,1>
  <DataSet=2_Bias_Circuit_CurrentSrc_TB.dat>
  <DataDisplay=2_Bias_Circuit_CurrentSrc_TB.dpl>
  <OpenDisplay=0>
  <Script=2_Bias_Circuit_CurrentSrc_TB.m>
  <RunScript=0>
  <showFrame=0>
  <FrameText0=Title>
  <FrameText1=Drawn By:>
...
<Components>
  <Sub SUB1 1 230 310 -10 -26 0 0 "2_Bias_Circuit.sch" 0>
  ...
  <.DC DC1 1 180 -150 0 38 0 0 "26.85" 0 "0.001" 0 "1 pA" 0 "1 uV" 0 "no" 0 "150" 0 "no" 0 "none" 0 "CroutLU" 0>
  <.SW SW1 1 870 -130 0 64 0 0 "DC1" 1 "lin" 1 "V1" 1 "0" 1 "1.2" 1 "1201" 1>
...
<Wires>
  ...
  <240 170 240 170 "VSUP" 200 120 0 "">
