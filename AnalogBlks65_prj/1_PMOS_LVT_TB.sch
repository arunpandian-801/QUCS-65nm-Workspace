...
<Properties>
  ...
  <Grid=10,10,1>
  <DataSet=1_PMOS_LVT_TB.dat>
  <DataDisplay=1_PMOS_LVT_TB.dpl>
  <OpenDisplay=0>
  <Script=1_PMOS_LVT_TB.m>
  <RunScript=0>
  <showFrame=0>
  <FrameText0=Title>
  <FrameText1=Drawn By:>
...
<Components>
  ...
  <SpicePar SpicePar1 1 770 140 -26 17 0 0 "vsg=420m" 1 "vsd=420m" 1 "vbs=0" 1>
  <PMOS_SPICE M1 1 290 500 -26 -72 1 0 "p_12_lllvt W=6.1u L=130n SA=160n SB=160n SD=0 AD=976f AS=976f PD=12.52u PS=12.52u SCA=4.26667 SCB=2.7103m SCC=457.234u" 0 "" 0 "" 0 "" 0 "" 0>
