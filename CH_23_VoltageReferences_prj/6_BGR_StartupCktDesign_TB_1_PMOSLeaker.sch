...
<Properties>
  ...
  <Grid=10,10,1>
  <DataSet=6_BGR_StartupCktDesign_TB_1_PMOSLeaker.dat>
  <DataDisplay=6_BGR_StartupCktDesign_TB_1_PMOSLeaker.dpl>
  <OpenDisplay=0>
  <Script=6_BGR_StartupCktDesign_TB_1_PMOSLeaker.m>
  <RunScript=0>
  <showFrame=0>
  <FrameText0=Title>
  <FrameText1=Drawn By:>
...
<Components>
  ...
  <SpicePar SpicePar1 1 770 140 -26 17 0 0 "vsg=1.06" 1 "vsd=423m" 1 "vbs=0" 1>
  <PMOS_SPICE M1 1 290 500 -26 -72 1 0 "p_12_llrvt W=1.3u L=65n SA=1.6e-07 SB=1.6e-07 SD=0 AS=208f AD=208f PS=2.92u PD=2.92u SCA=18.3908 SCB=12.6274m SCC=2.14545m" 0 "" 0 "" 0 "" 0 "" 0>
</Components>
<Wires>
