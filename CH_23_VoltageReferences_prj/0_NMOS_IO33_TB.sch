...
<Properties>
  ...
  <Grid=10,10,1>
  <DataSet=0_NMOS_IO33_TB.dat>
  <DataDisplay=0_NMOS_IO33_TB.dpl>
  <OpenDisplay=0>
  <Script=1_NMOS_IO33_TB.m>
  <RunScript=0>
  <showFrame=0>
  <FrameText0=Title>
  <FrameText1=Drawn By:>
...
<Components>
  ...
  <SpicePar SpicePar1 1 770 140 -26 17 0 0 "vgs=740m" 1 "vds=740m" 1 "vsb=0" 1>
  <NMOS_SPICE M1 1 290 440 -26 34 0 0 "n_25od33_ll W=2.9u L=500n SA=175n SB=175n SD=0 AS=507.5f AD=507.5f PS=6.15u PD=6.15u SCA=2.6534  SCB=2.36239m SCC=105.344u" 0 "" 0 "" 0 "" 0 "" 0>
