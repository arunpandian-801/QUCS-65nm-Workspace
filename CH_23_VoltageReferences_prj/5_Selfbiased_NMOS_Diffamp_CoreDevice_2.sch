...
<Properties>
  ...
  <Grid=10,10,1>
  <DataSet=5_Selfbiased_NMOS_Diffamp_CoreDevice_2.dat>
  <DataDisplay=5_Selfbiased_NMOS_Diffamp_CoreDevice_2.dpl>
  <OpenDisplay=0>
  <Script=5_Selfbiased_NMOS_Diffamp_CoreDevice_2.m>
  <RunScript=0>
  <showFrame=0>
  <FrameText0=Title>
  <FrameText1=Drawn By:>
...
<Components>
  ...
  <NMOS_SPICE M3 1 520 610 -36 17 0 0 "n_12_llrvt W=2.8e-06 L=5.2e-07 NF=1 SA=1.6e-07 SB=1.6e-07 SD=0 AD=4.48e-13 AS=4.48e-13 PD=5.92e-06 PS=5.92e-06 SCA=9.03955 SCB=0.00590454 SCC=0.000996117" 0 "" 0 "" 0 "" 0 "" 0>
</Components>
<Wires>
  ...
  <540 720 540 610 "VSS" 570 640 50 "">
  <520 640 520 720 "" 0 0 0 "">
  <490 610 450 610 "" 0 0 0 "">
  <450 610 450 610 "Vbias" 390 560 0 "">
</Wires>
<Diagrams>
</Diagrams>
<Paintings>
  <Text 360 380 16 #ff0000 0 "43/2">
  <Text 630 390 16 #ff0000 0 "43/2">
  <Text 550 570 16 #ff0000 0 "43/8">
