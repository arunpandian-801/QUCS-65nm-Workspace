...
<Properties>
  <View=-296,-150,2111,1332,0.501471,0,61>
  <Grid=10,10,1>
...
<Paintings>
  ...
  <Text 490 780 18 #ff0000 0 "COMPUTING PTAT VOLTAGE SOURCE - L*R resistor">
  <Text 70 830 14 #000000 0 "V_{BGR} = VQ_3 + L * η * ln K * V_T\n~\nFrom SPICE Model "pnp-v20x20-ll" we need to get η.\nSince this is a diode connected PNP => Emitter P - Base N Diode\n(Collector is shorted and also reverse biased)\n~\nForward "Base - emitter" Diode is modelled using IS and NF (Forward\nEmission Coefficient)\n~\nAnd that is: "NF = η = 1003.6e-3"\n~\nδV_{BGR}/δT = δVQ_3/δT + L * η * ln K * δV_T/δT = 0 (For ZTC)\n~\nδVQ_3/δT = - 1.75 mV/C (From 1-PNP-VD.sch See for 8 Parallel PNP Diodes)">
  <Text 760 840 14 #000000 0 "Therefore,\nL = (-δVQ_3/δT) / (η * ln K * δV_T/δT)\n~\nδV_T/δT = 0.085 mV/C\n~\nPlug and Chug, L = (-(-1.75m))/(1003.6e-3 * ln 8 * 0.085m) = 9.865\n~\nTherefore L * R = 9.865 * 10.9 kΩ = 107.53 kΩ.">
  <Text 760 1060 14 #0000ff 0 "Later manually adjusted to 96 kΩ to get BGR Bow">
  <Rectangle 50 770 1310 410 #000000 2 1 #c0c0c0 1 0>
  <Line 720 810 0 370 #000000 2 2>
  <Line 50 810 1310 0 #000000 2 1>
  <Text 1530 800 18 #ff0000 0 "Temperature Performance">
  <Text 1470 850 14 #000000 0 "Refer to "4-BGR.sch" for info">
  <Rectangle 1440 800 500 90 #000000 2 1 #c0c0c0 1 0>
  <Line 1440 830 500 0 #000000 2 1>
</Paintings>
