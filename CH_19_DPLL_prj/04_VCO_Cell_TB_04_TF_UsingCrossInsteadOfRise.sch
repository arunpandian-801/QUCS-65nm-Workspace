...
<Properties>
  <View=2,-534,1257,1351,1,24,0>
  <Grid=10,10,1>
  <DataSet=04_VCO_Cell_TB_04_TF_UsingCrossInsteadOfRise.dat>
  <DataDisplay=04_VCO_Cell_TB_04_TF_UsingCrossInsteadOfRise.dpl>
  <OpenDisplay=0>
  <Script=04_VCO_Cell_TB_04_TF_UsingCrossInsteadOfRise.m>
  <RunScript=0>
  <showFrame=0>
  <FrameText0=Title>
  <FrameText1=Drawn By:>
...
<Diagrams>
  ...
  <Rect 150 1130 240 160 3 #c0c0c0 1 00 1 0 0.2 1 1 -0.1 0.5 1.1 1 -0.1 0.5 1.1 315 0 225 1 0 0 "" "" "">
	<"ngspice/04_VCO_Cell_TB_02_TF:sweep1.tfval@sweep1.vinsweep" #ff0000 2 3 0 0 0>
  </Rect>
</Diagrams>
<Paintings>
  <Text 300 -130 22 #0000ff 0 "CONCLUSION">
  <Text 150 -70 16 #000000 0 "Screw this. I am going to manually get the TF Curves!">
  <Rectangle 130 -140 530 110 #000000 2 1 #c0c0c0 1 0>
  <Line 130 -90 530 0 #000000 2 1>
  <Text 360 -370 26 #0000ff 0 "UPDATE">
  <Text 100 -320 18 #000000 0 "This shitty TF is due to insufficient Transient Simulation points.\n~\nRefer to "04-VCO-Cell-TB-05-TF-MoreTransienTSimPoints.sch"\nfor correct curve!">
  <Rectangle 80 -370 690 170 #000000 2 1 #c0c0c0 1 0>
  <Line 80 -330 690 0 #000000 2 1>
</Paintings>
