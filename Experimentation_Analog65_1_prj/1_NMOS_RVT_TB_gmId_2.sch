...
<Properties>
  <View=-24,-5,1144,655,1.03333,0,0>
  <Grid=10,10,1>
...
<Components>
  ...
  <NMOS_SPICE M1 1 290 440 -26 34 0 0 "n_12_llrvt W=3.3e-06 L=1.3e-07 NF=1 SA=1.6e-07 SB=1.6e-07 SD=0 AD=5.28e-13 AS=5.28e-13 PD=6.92e-06 PS=6.92e-06 SCA=7.72947 SCB=0.00500994 SCC=0.00084519" 0 "" 0 "" 0 "" 0 "" 0>
  <SpicePar SpicePar1 1 770 140 -26 17 0 0 "vgs=500m" 1 "vds=100m" 1 "vsb=0" 1>
  <.CUSTOMSIM CUSTOM1 1 740 350 0 32 0 0 "\nsave @M1[cgg] @M1[w] @M1[id] @M1[gm]\ndc v1 0 1.2 1m\n\nlet fT = @M1[gm]/(2*pi*(@M1[cgg]))\nlet gmId = @M1[gm]/@M1[id]\nlet IdW = @M1[id]/@M1[w]\n\nwrite custom#step1#.plot fT gmId IdW\n" 1 "" 0 "custom#step1#.plot" 0>
</Components>
<Wires>
