...
<Properties>
  <View=-22,-8,1143,655,1.03647,0,5>
  <Grid=10,10,1>
...
<Components>
  ...
  <.SW SW1 1 920 40 0 52 0 0 "DC1" 1 "lin" 1 "V1" 1 "0" 1 "0.6" 1 "601" 1>
  <NutmegEq NutmegEq2 1 770 350 -27 17 0 0 "SW1" 1 "gm=deriv(i(vpr1))" 1>
  <.SW SW2 1 750 450 0 52 0 0 "DC1" 1 "lin" 1 "V2" 1 "0" 1 "1.2" 1 "1201" 1>
  <NutmegEq NutmegEq3 1 610 340 -27 17 0 0 "SW2" 1 "rout=1/deriv(i(vpr1))" 1>
  <SpicePar SpicePar1 1 770 140 -26 17 0 0 "vgs=470m" 1 "vds=100m" 1 "vsb=0" 1>
  <NMOS_SPICE M1 1 290 440 -26 34 0 0 "n_12_llrvt W=5.1e-06 L=1.3e-07 NF=1 SA=1.6e-07 SB=1.6e-07 SD=0 AD=8.16e-13 AS=8.16e-13 PD=1.052e-05 PS=1.052e-05 SCA=5.07937 SCB=0.00324173 SCC=0.000546888" 0 "" 0 "" 0 "" 0 "" 0>
</Components>
<Wires>
