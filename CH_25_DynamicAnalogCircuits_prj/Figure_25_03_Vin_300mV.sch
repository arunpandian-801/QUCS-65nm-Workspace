...
<Properties>
  <View=-8,-369,1231,725,1,8,360>
  <Grid=10,10,1>
  <DataSet=Figure_25_03_Vin_300mV.dat>
  <DataDisplay=Figure_25_03_Vin_300mV.dpl>
  <OpenDisplay=0>
  <Script=Figure_25_03_Vin_300mV.m>
  <RunScript=0>
  <showFrame=0>
  <FrameText0=Title>
  <FrameText1=Drawn By:>
...
<Components>
  ...
  <C C1 1 310 550 17 -26 0 1 "1 pF" 1 "" 0 "neutral" 0>
  ...
  <Vdc V1 1 70 550 18 -26 0 1 "0.3 V" 1>
</Components>
<Wires>
  ...
  <70 520 70 510 "" 0 0 0 "">
  <430 590 430 570 "" 0 0 0 "">
  <430 510 430 470 "" 0 0 0 "">
...
<Diagrams>
  ...
  <Rect 620 598 513 538 3 #c0c0c0 1 00 0 8e-08 5e-10 8.2e-08 0 0.298 0.001 0.302 1 -1 0.2 1 315 0 225 1 0 0 "" "" "">
	<"ngspice/tran.v(vout)" #0000ff 2 3 0 0 0>
	  <Mkr 8.06995e-08 97 -429 5 0 0>
	  <Mkr 8.13015e-08 228 -172 5 0 0>
  </Rect>
</Diagrams>
<Paintings>
  <Text 230 460 16 #ff0000 0 "10/1">
  <Text 160 350 12 #000000 0 "CHARGE INJECTION FOR V_{IN} = 0.3 V">
